...
//             {!hasApplied() && (
//               <button
//                 onClick={() => handleAddApplication(jobData._id)}
...
//           {jobData.roles.map((role) => role.description).join("\n\n")}
//         </p>
//       </div>
...
//               disabled={!isEligible(jobData.roles[0].eligibility)}
//             >
//               {isEligible(jobData.roles[0].eligibility)
//                 ? "Apply"
//                 : "Not Eligible"}
//             </button>
//             {!isEligible(jobData.roles[0].eligibility) && (
//               <span className="absolute w-36 mb-4 bottom-full left-1/2 transform -translate-x-1/2 translate-y-1 space-x-1 bg-gray-700 text-white text-sm p-2 rounded-md opacity-0 group-hover:opacity-100 transition-opacity">
