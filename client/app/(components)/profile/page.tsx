  ...
  return (
    ...
    >
      <div className="mx-auto max-w-242.5">
        ...
        {edit ? (
          <div className="mt-10.5 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="flex flex-col gap-5.5 p-6.5">
              <div className="flex items-center gap-5">
                <label className="text-md  w-[120px] font-medium text-black dark:text-white">
                  Name
                </label>
                {/* <p className="w-full text-md bg-transparent px-5  text-black outline-none transition  disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
              >Jon Doe</p> */}
              ...
              <div className="flex items-center gap-5">
                ...
                {/* <p className="text-md w-full bg-transparent px-5  text-black outline-none transition  disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                  12345
                </p> */}
          ...
          <div className="mt-10.5 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="flex flex-col gap-5.5 p-6.5">
              <div className="flex gap-5">
                <label className="text-md mb-3 w-[120px] font-medium text-black dark:text-white">
                  Name
                </label>
                <p className="text-md w-full bg-transparent px-5  text-black outline-none transition  disabled:bg-whiter dark:border-form-strokedark dark:text-white dark:focus:border-primary">
                  Jon Doe
                </p>
              </div>
